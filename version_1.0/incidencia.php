    ...
    <section class="container">
        <div class="emergency_container">
            <table>
                ...
                $sql_select = "SELECT r.consecutivo, u.nombre, u.apellido_paterno, u.apellido_materno, u.email, u.tipo, r.fecha, r.hora, r.descripcion, r.observacion, r.estado FROM reporte r INNER JOIN usuarios u ON r.credencial = u.credencial WHERE r.incidencia = '1'";
