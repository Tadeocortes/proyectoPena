<?php
	include("../codigos/registrar/administrativos.php");
?>
<!DOCTYPE html>
<html>
  <head>
    ...
    <meta name="viewport" content="width=device-width,
      initial-scale=1.0"/>
    <link rel="stylesheet" href="../estilos/registroadministrativos.css" />
  </head>
  <body>
    <div class="container">
      <h1 class="form-title">Registar administrativos</h1>
      <form method="post">
