...
if ($_SERVER["REQUEST_METHOD"] == "POST") {
    ...
    $sql_insert = "INSERT INTO reporte (credencial,incidencia,descripcion,observacion , fecha, hora, estado) VALUES ('$credencial','1','$tipoEmergencia', '$descripcion', CURDATE(), CURTIME(), 'Sin Atender')";
